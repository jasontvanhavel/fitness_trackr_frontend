...
const RoutineCreationForm = ({setRoutinesToDisplay, routinesToDisplay, activities, setActivities}) => {
    ...
    async function createRoutine() {
        ...
        try {
            ...
            // using concat here so that routinesToDisplay is only updated with the useState
            // this updates the displayed routines to include the new one
    ...
    return <div id="creation-form">
        ...
        <div id="activities-input">
            ...
            <button onClick={() => {
                // creating the activity to be added to the routine
